                            ...
                            <div className="row">
                                <div className="col-md-12">
                                    ...
                                    <div className="pull-left">
                                        <img src="http://i.imgur.com/RSYzH91b.jpg" className="img-responsive img-rounded" alt="sujak" />
                                    </div>
                                        ...
                                        <h3>Nurse</h3>
                                            <p>I am currently a surgical nurse and had worked in critical care for six years. I currently enjoy my job 
                                        ...
                                        <h3>Gamer</h3>
                                            <div className="pull-right">
                                                <img src="http://i.imgur.com/HAcV43dl.jpg" className="img-responsive img-rounded" alt="blizzcon" />
                                                <div className="caption">
                                                    <p>BlizzCon 2014 with the Crew</p>
                                                </div>
                                            </div>
