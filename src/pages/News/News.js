				...
				<div className="row">
					...
					<div className="col-md-8">
						<div className="well">
							...
							<p>I'm very excited to announce this site is running as of June 30, 2017.</p>
							<br />
							...
							<p>Here is a direct link to the FCC's proposition ironically named "Restoring Internet Freedom":
								<a 
									href="https://apps.fcc.gov/edocs_public/attachmatch/FCC-17-60A1.pdf"
									target="_blank"
									rel="noopener noreferrer">Docket No. 17-108
								</a>. Please comment on the FCC's website regarding 17-108, or use
								<a
									href="https://www.battleforthenet.com/"
									target="_blank"
									rel="noopener noreferrer">Battle for the Net
								</a> to send your comments to the FCC and Congress.
							</p>
							<br />
							<h1>Other News</h1>
								<h2>Graduation</h2>
